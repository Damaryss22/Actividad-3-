// SERVIDOR MCP SIMPLE - FUNCIONAL PARA EXAMEN
...
// 📊 DATOS DE AUDITORÍA (HARDCODED PARA DEMOSTRACIÓN)
const AUDIT_DATA = [
    {
        logId: 77,
        exam2p_entity: "User",
...
app.post("/gemini/chat", async (req, res) => {
    ...
    try {
        ...
        // Verificar si quiere usar la tool
        ...
        if (functionCall && functionCall.name === "exam2p_query_audit") {
            ...
            // Enviar resultado de la tool de vuelta a Gemini
